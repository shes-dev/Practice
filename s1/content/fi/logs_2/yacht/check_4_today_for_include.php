...
//funcs
	...
	{
		$sql1="INSERT INTO `Ie_comp_today_v`(`UPDATED`, `VETERAN`) VALUES ('".$num."','3') ";
	...
	{
		$sql1="INSERT INTO `Ie_comp_today_v`(`UPDATED`, `VETERAN`) VALUES ('".$num."','7') ";
		$query = mysqli_query($m,$sql1);	
	}
	...
	{
		$sql1="INSERT INTO `Ie_comp_today_v`(`UPDATED`, `VETERAN`) VALUES ('".$num."','14') ";
		$query = mysqli_query($m,$sql1);	
	}
//-------------today--------------//
...
// getting all entries from yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 1 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
	...
	while ($row = mysqli_fetch_array($query,MYSQLI_ASSOC))
		...
		//debugging
/*		echo '<pre>';
		echo 'SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 1 DAY;';
		echo '<br>';
		var_dump($row);
		echo '<br>';
		...
		var_dump($y);
		echo '<br>';
		echo 'query of all who did tr yesterday before double check:';
		echo '<br>';
		var_dump($con);
		echo '</pre>';
*/	
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 2 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 3 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 4 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 5 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 6 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 7 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 8 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 9 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 10 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 11 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 12 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 13 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries from the day before yesterday
	//sql
	$sql1="SELECT * FROM `Ie_comp_today` WHERE DATE(`TIME`) = CURDATE() - INTERVAL 14 DAY;";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries where veteran = 3
	//sql
	$sql1="SELECT * FROM `Ie_comp_today_v` WHERE `VETERAN` = 3";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries where veteran = 7
	//sql
	$sql1="SELECT * FROM `Ie_comp_today_v` WHERE `VETERAN` = 7";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries where veteran = 14
	//sql
	$sql1="SELECT * FROM `Ie_comp_today_v` WHERE `VETERAN` = 14";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
...
// getting all entries where crown = 1
	//sql
	$sql1="SELECT * FROM `Ie_comp_today_c` WHERE `CROWN` = 1";
	$query = mysqli_query($con,$sql1);	
	//$row = mysqli_fetch_array($query,MYSQLI_ASSOC);
