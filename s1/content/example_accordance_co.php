...
// Connecting End
	...
	if ($Li_yn == 'y')
	{	
		$sql1='UPDATE table_co SET accordance = accordance + 1 WHERE ID = '.$Li_yn_num.'';
		$sql2='UPDATE table_co SET popularity = popularity + 1 WHERE ID = '.$Li_yn_num.'';
	}
	if ($Li_yn == 'n')
	{	
		$sql1='UPDATE table_co SET accordance = accordance - 1 WHERE ID = '.$Li_yn_num.'';
	...
	echo '<h3 style="margin:0px auto;"><u>Accordance co sql:</u></h3>';
	var_dump($sql1);
