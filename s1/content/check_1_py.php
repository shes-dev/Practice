...
// Connecting End
	...
	include 'fi/logs_2/yacht/check_4_today_for_include_py.php';
	
	// Getting Keys
	$sql1="SELECT * FROM Ie_comp_data_py ORDER BY ID DESC LIMIT 1";
...
*/
	// Getting values
	$sql1="SELECT * FROM Ie_comp_py ORDER BY ID DESC LIMIT 1";
	$query = mysqli_query($con,$sql1);	
